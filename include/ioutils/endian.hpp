...
static inline uint16_t host_to_net(uint16_t x){
    return htons(x);
}

static inline uint32_t host_to_net(uint32_t x){
    return htonl(x);
}
...
static inline uint16_t net_to_host(uint16_t x) {
    return ntohs(x);
}

static inline uint32_t net_to_host(uint32_t x){
    return ntohl(x);
}
