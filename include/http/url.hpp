...
struct url {
  ...
  static constexpr std::string_view to_string(url_err e){
    ...
    switch(e){
      case url_err::invalid_proto: return "invalid_proto"sv;
      case url_err::invalid_host : return "invalid_host"sv;
      case url_err::invalid_path : return "invalid_path"sv;
      case url_err::invalid_query: return "invalid_query"sv;
    };
    return ""sv;
  }
