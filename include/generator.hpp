...
template <class T> class generator : private non_copyable {
public:
  class promise;
  class iterator;
  ...
  public:
    ...
    // disable co_await
    template <class U> std::suspend_never await_transform(U &&value) = delete;

  private:
    friend class iterator;
    value_type *get_if() const noexcept { return m_value_ptr; }
